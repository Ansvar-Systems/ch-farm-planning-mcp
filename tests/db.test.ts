...
describe('database layer', () => {
  ...
  test('all domain tables exist', () => {
    ...
    expect(names).toContain('sak_factors');
    expect(names).toContain('business_structures');
    expect(names).toContain('tax_rules');
    expect(names).toContain('succession_planning');
    expect(names).toContain('gross_margins');
    expect(names).toContain('financial_guidance');
